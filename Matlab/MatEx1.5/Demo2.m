% Demo2   Generates the CM3 in Alk.m with measurement errors + analyse

CM3='CM3'; % 'CM3' for the CM3 in Alk.m or 'M4' for a random M4
...
xlabel('space'); ylabel('time'); zlabel('Process value'); view(45,30)
hold off
end
