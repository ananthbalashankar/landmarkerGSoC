% Demo4   Histogram plots given K=Kest and L=Lest (takes time)
%	  Output saved in Hvec.mat
...
clustering='pam'; % 'best', 'exact', 'ward', 'pam' or 'approachedM' (-M or -U)
...
plotprocess='OFF'; % 'ON' or 'OFF'
iffile='OFF'; % 'ON' or 'OFF'
withR='OFF'; % 'ON' or 'OFF'
estimatesK='OFF'; % 'ON' or 'OFF'
estimatesL='OFF'; % 'ON' or 'OFF'
plotL='OFF'; % 'ON' or 'OFF'
